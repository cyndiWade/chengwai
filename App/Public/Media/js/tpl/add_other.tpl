    ...
    <div class="add_account">
        <form method="post" action="information/account/submitaccount" name="accountRegistor" id="accountRegistor">
            <table width="100%" border="0" cellspacing="0" cellpadding="0">
                    ...
                    <td width="34%" valign="middle">
                        <div style="position:relative">
                            <div class="add_account_pic">
                                <img data-bind="attr: {src: notice_img}" style="width:235px;height:143px;float:left;">
                            </div>
                        </div>
                    </td>
                </tr>
                ...
                <tr>
                    <th height="45" align="right" valign="top"><em>*</em>链接：</th>
                    <td valign="top">
                        <div class="add_account_divTxt">
                            <input data-bind="noticeImg: platform_url_img, validThreeState: url, value: url" type="text" class="input_txt"
                                   name="url"/>
                        </div>
                        <p data-bind="html: url.notice_text, css: url.notice_css" class="cBox_tip" id="url"></p></td>
                    <td valign="middle"></td>
                </tr>
                <tr>
